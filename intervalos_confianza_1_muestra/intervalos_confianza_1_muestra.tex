...
Se pide:
\begin{enumerate}
\item  Crear la variable \variable{concentracion}, e introducir los 
datos de la muestra.
...
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{concentracion} en el campo
\campo{Lista de dependientes} y hacer click en el botón \boton{Estadísticos}.
\item En el cuadro de diálogo que aparece habilitar la opción \opcion{Descriptivos}, introducir el nivel
de confianza deseado en el cuadro \campo{Intervalo de confianza para la media}, y hacer 
click en el botón \boton{Continuar} y \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Analizar\flecha Estadísticos descriptivos\flecha Explorar}.
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{grasa} en el campo
\campo{Lista de dependientes} y hacer click en el botón \boton{Estadísticos}.
\item En el cuadro de diálogo que aparece habilitar la opción \opcion{Descriptivos}, introducir el nivel
de confianza deseado en el cuadro \campo{Intervalo de confianza para la media}, y hacer 
click en el botón \boton{Continuar} y \boton{Aceptar}.
...
dividiendo los datos según la granja de procedencia de la leche. \begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Analizar\flecha Estadísticos descriptivos\flecha Explorar}.
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{grasa} en el campo
\campo{Lista de dependientes}, seleccionar la variable \variable{granja} en el campo \campo{Lista de factores} y hacer click en el botón
\boton{Estadísticos}.
\item En el cuadro de diálogo que aparece habilitar la opción \opcion{Descriptivos}, introducir el nivel
de confianza deseado en el cuadro \texttt{Intervalo de confianza para la media}, y hacer click en el botón
\boton{Continuar} y \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\item En una encuesta realizada en una facultad, sobre si los alumnos utilizan habitualmente (al menos una vez a la
semana) la biblioteca de la misma, se han obtenido los siguientes resultados, en los que se ha anotado 1 si la respuesta
ha sido positiva y 0 si ha sido negativa:
\begin{center}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Analizar\flecha Estadísticos descriptivos\flecha Explorar}.
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{respuesta} en el campo
\campo{Lista de dependientes} y hacer click en el botón \boton{Estadísticos}.
\item En el cuadro de diálogo que aparece habilitar la opción \opcion{Descriptivos}, introducir el nivel
de confianza deseado en el cuadro \campo{Intervalo de confianza para la media}, y hacer click en el botón
\boton{Continuar} y \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Crear la variable \variable{respuesta} cuyos dos únicos valores serán 0 para las respuestas negativas, y 1 para
las positivas, y una segunda variable que podemos denominar \variable{frecuencia} cuyos valores son las frecuencias
absolutas de cada una de las respuestas (46 para la respuesta 0 y 154 para la respuesta 1).

\item Ponderar los valores de la variable \variable{respuesta} mediante los pesos introducidos en la variable
\variable{frecuencia}.
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Datos\flecha Ponderar casos}.
\item En el cuadro de diálogo que aparece activar la opción \opcion{Ponderar casos mediante}, seleccionar la variable
\variable{frecuencia} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
